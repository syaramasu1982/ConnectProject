...
#
	...
	| Annual Leave Days | Annual Leave Days | future date  | future date  | 0.50     | Submitted on today | Pending       | Leave Request | Fraser, Gavin | To action | 0.5 day      | Approved       | Gavin Fraser   |
	| Annual Leave Days | Annual Leave Days | past date    | past date    | 0.50     | Submitted on today | Pending       | Leave Request | Fraser, Gavin | To action | 0.5 day      | Approved       | Gavin Fraser   |
	| Sickness          | Bacterial         | current date | current date |          | Submitted on today | Pending       | Leave Request | Fraser, Gavin | To action | 1 day        | Approved       | Gavin Fraser   |  
...
Examples:
	...
	| Industrial Action  | Industrial Action | past date   | past date   | 1.00     | Submitted on today | 1 day        | Gavin Fraser   | Taken    |
	| Special Leave Paid | Training          | future date | future date | 1.50     | Submitted on today | 1.5 days     | Gavin Fraser   | Approved |
	| Annual Leave Days  | Annual Leave Days | future date | future date | 0.30     | Submitted on today | 0.3 day      | Gavin Fraser   | Approved |  
