...
#line 1 "My AnnualeaveRegressionPackSIT.feature"
#line hidden
        ...
        public static void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/EndToEndTests/Updated/SIT5", "My Annual Leave End to End Automation", null, ProgrammingLanguage.CSharp, featureTags);
        ...
        [Xunit.InlineDataAttribute("Annual Leave Days", "Annual Leave Days", "future date", "future date", "0.50", "Submitted on today", "Pending", "Leave Request", "Fraser, Gavin", "To action", "0.5 day", "Approved", "Gavin Fraser", new string[0])]
        [Xunit.InlineDataAttribute("Annual Leave Days", "Annual Leave Days", "past date", "past date", "0.50", "Submitted on today", "Pending", "Leave Request", "Fraser, Gavin", "To action", "0.5 day", "Approved", "Gavin Fraser", new string[0])]
        [Xunit.InlineDataAttribute("Sickness", "Bacterial", "current date", "current date", "", "Submitted on today", "Pending", "Leave Request", "Fraser, Gavin", "To action", "1 day", "Approved", "Gavin Fraser", new string[0])]
...
#line hidden
        ...
        [Xunit.TraitAttribute("Category", "smoketest")]
        [Xunit.InlineDataAttribute("Industrial Action", "Industrial Action", "past date", "past date", "1.00", "Submitted on today", "1 day", "Gavin Fraser", "Taken", new string[0])]
        [Xunit.InlineDataAttribute("Special Leave Paid", "Training", "future date", "future date", "1.50", "Submitted on today", "1.5 days", "Gavin Fraser", "Approved", new string[0])]
        [Xunit.InlineDataAttribute("Annual Leave Days", "Annual Leave Days", "future date", "future date", "0.30", "Submitted on today", "0.3 day", "Gavin Fraser", "Approved", new string[0])]
