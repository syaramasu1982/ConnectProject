...
Examples:
	...
	| UK Claims       | Assign Diff BA | 11.06.21 | 7.01    | Breakfast - Early Start            | Breakfast      | 13.93   | Parking/Tolls            | Parking        | 14.00   | Lunch                          | Lunch          | Saved       |           | Private Car - Standard Rate | 10    | Mileage       | 100002     | 000001    | 00004     | Approver: Lynch, Doctor Roslyn Mariette (Ros Lynch) | 102040           | 100180          | 00002          |               | Pending Manager Approval |
	| Overseas Claims | Assign Diff BA | 11.06.21 | 7.01    | Overseas Meals - Breakfast - Other | Breakfast      | 13.93   | Overseas Parking & Tolls | Parking        | 14.00   | Overseas Meals - Lunch - Other | Lunch          | Saved       | US Dollar | Overseas Trip - UK Mileage  | 10    | Mileage       | 100002     | 000001    | 00004     | Approver: Lynch, Doctor Roslyn Mariette (Ros Lynch) | 102040           | 100180          | 00002          |               | Pending Manager Approval |  
...
Scenario Outline: 02 Employee submits my expenses request, Manager approves claim and employee validates approve claim notification
	...
	When I click on notifications
	Then I should see list of notification and some filters
	And I should see the status of my expense has been approved |"Expense", "has been approved", "Lynch, Ros Lynch"|
	...
	| UK Claims       | Trip to Italy Approve | 11.06.21 | 5      | Lunch                              | Testing       | Pending Manager Approval |           | Private Car - Standard Rate | 10    | The following fields are required | Fraser, Gavin | Lynch, Ros Lynch | Automation | Approver: Lynch, Doctor Roslyn Mariette (Ros Lynch) |
	| Overseas Claims | Trip to Italy Approve | 11.06.21 | 5      | Overseas Meals - Breakfast - Other | Testing       | Pending Manager Approval | US Dollar | Overseas Trip - UK Mileage  | 10    | The following fields are required | Fraser, Gavin | Lynch, Ros Lynch | Automation | Approver: Lynch, Doctor Roslyn Mariette (Ros Lynch) |
...
Scenario Outline: 03 Employee submits my expenses Manager rejects claim and employee validates rejected claim notification
	...
	Examples:
	| templateName    | description           | date     | amount | expenseType                        | justification | claimStatusPending       | currency  | mileageType                 | miles | errorMessage                      | empName      | managerName       | title      | approverName                                        |  
	| UK Claims       | Trip to Italy Rejects | 11.06.21 | 5      | Lunch                              | Testing       | Pending Manager Approval |           | Private Car - Standard Rate | 10    | The following fields are required | Fraser, Gavin | Lynch, Ros Lynch | Automation | Approver: Lynch, Doctor Roslyn Mariette (Ros Lynch) |
	| Overseas Claims | Trip to Italy Rejects | 11.06.21 | 5      | Overseas Meals - Breakfast - Other | Testing       | Pending Manager Approval | US Dollar | Overseas Trip - UK Mileage  | 10    | The following fields are required | Fraser, Gavin | Lynch, Ros Lynch | Automation | Approver: Lynch, Doctor Roslyn Mariette (Ros Lynch) |
...
Scenario Outline: 04 Employee withdraw expenses, edit withdrawn expense and delete
	...
	Examples:
        ...
        | UK Claims       | Trip to London Withdraw | 11.06.21 | 5      | Lunch                          | Testing       | Pending Manager Approval |           | Approver: Lynch, Doctor Roslyn Mariette (Ros Lynch)  | Withdrawn           | 10        | Hospitality    |
        | Overseas Claims | Trip to London Withdraw | 11.06.21 | 5      | Overseas Meals - Lunch - Other | Testing       | Pending Manager Approval | US Dollar | Approver: Lynch, Doctor Roslyn Mariette (Ros Lynch)  | Withdrawn           | 10        | Hospitality    |
