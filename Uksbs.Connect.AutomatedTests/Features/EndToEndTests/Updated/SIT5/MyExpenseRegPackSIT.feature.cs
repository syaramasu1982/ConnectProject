...
#line 1 "MyExpenseRegPackSIT.feature"
#line hidden
        ...
        public static void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/EndToEndTests/Updated/SIT5", "My Expenses End to End Automation", null, ProgrammingLanguage.CSharp, featureTags);
        ...
        [Xunit.InlineDataAttribute("UK Claims", "Assign Diff BA", "11.06.21", "7.01", "Breakfast - Early Start", "Breakfast", "13.93", "Parking/Tolls", "Parking", "14.00", "Lunch", "Lunch", "Saved", "", "Private Car - Standard Rate", "10", "Mileage", "100002", "000001", "00004", "Approver: Lynch, Doctor Roslyn Mariette (Ros Lynch)", "102040", "100180", "00002", "", "Pending Manager Approval", new string[0])]
...
#line hidden
        ...
        [Xunit.TraitAttribute("Description", "02 Employee submits my expenses request, Manager approves claim and employee vali" +
            "dates approve claim notification")]
        [Xunit.TraitAttribute("Category", "smoketest")]
        [Xunit.InlineDataAttribute("UK Claims", "Trip to Italy Approve", "11.06.21", "5", "Lunch", "Testing", "Pending Manager Approval", "", "Private Car - Standard Rate", "10", "The following fields are required", "Fraser, Gavin", "Lynch, Ros Lynch", "Automation", "Approver: Lynch, Doctor Roslyn Mariette (Ros Lynch)", new string[0])]
        [Xunit.InlineDataAttribute("Overseas Claims", "Trip to Italy Approve", "11.06.21", "5", "Overseas Meals - Breakfast - Other", "Testing", "Pending Manager Approval", "US Dollar", "Overseas Trip - UK Mileage", "10", "The following fields are required", "Fraser, Gavin", "Lynch, Ros Lynch", "Automation", "Approver: Lynch, Doctor Roslyn Mariette (Ros Lynch)", new string[0])]
...
#line 159
 testRunner.And("I should see the status of my expense has been approved |\"Expense\", \"has been app" +
                        "roved\", \"Lynch, Ros Lynch\"|", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
#line 160
...
#line hidden
        ...
        [Xunit.TraitAttribute("Description", "03 Employee submits my expenses Manager rejects claim and employee validates reje" +
            "cted claim notification")]
        [Xunit.TraitAttribute("Category", "smoketest")]
        [Xunit.InlineDataAttribute("UK Claims", "Trip to Italy Rejects", "11.06.21", "5", "Lunch", "Testing", "Pending Manager Approval", "", "Private Car - Standard Rate", "10", "The following fields are required", "Fraser, Gavin", "Lynch, Ros Lynch", "Automation", "Approver: Lynch, Doctor Roslyn Mariette (Ros Lynch)", new string[0])]
        [Xunit.InlineDataAttribute("Overseas Claims", "Trip to Italy Rejects", "11.06.21", "5", "Overseas Meals - Breakfast - Other", "Testing", "Pending Manager Approval", "US Dollar", "Overseas Trip - UK Mileage", "10", "The following fields are required", "Fraser, Gavin", "Lynch, Ros Lynch", "Automation", "Approver: Lynch, Doctor Roslyn Mariette (Ros Lynch)", new string[0])]
...
#line hidden
        ...
        [Xunit.TraitAttribute("Category", "smoketest")]
        [Xunit.InlineDataAttribute("UK Claims", "Trip to London Withdraw", "11.06.21", "5", "Lunch", "Testing", "Pending Manager Approval", "", "Approver: Lynch, Doctor Roslyn Mariette (Ros Lynch)", "Withdrawn", "10", "Hospitality", new string[0])]
        [Xunit.InlineDataAttribute("Overseas Claims", "Trip to London Withdraw", "11.06.21", "5", "Overseas Meals - Lunch - Other", "Testing", "Pending Manager Approval", "US Dollar", "Approver: Lynch, Doctor Roslyn Mariette (Ros Lynch)", "Withdrawn", "10", "Hospitality", new string[0])]
