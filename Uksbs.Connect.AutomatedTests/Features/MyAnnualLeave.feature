Feature: MyAnnualLeave
	I should be able to: login, and to see My Annual Leave tile. 
	And also I should  be able to change the line manager of my employee.

@connect-regression @myannualleave @boe
Scenario Outline: 01 Employee creates leave request, manager approves leave request, employee verifies the status and manager deletes approved leaves
	...
	| Annual Leave Days            | Annual Leave Days | future date  | future date  | 0.50     | Submitted on today | Pending       | Leave Request | Norris, Mark | To action | 0.5 day      | Approved       | Mark Norris    |
	| Annual Leave Days            | Annual Leave Days | past date    | past date    | 0.50     | Submitted on today | Pending       | Leave Request | Norris, Mark | To action | 0.5 day      | Approved       | Mark Norris    |
	| Sickness                     | Bacterial         | current date | current date |          | Submitted on today | Pending       | Leave Request | Norris, Mark | To action | 1 day        | Approved       | Mark Norris    |
...
@connect-regression @myannualleave @boe
Scenario: 02 Employee creates annual leave and manager declines leave request
	Given I login as an employee
	Then I should see my annual leave tile in dashboard
...
Examples:
	...
	| Industrial Action  | Industrial Action | past date   | past date   | 1.00     | Submitted on today | 1 day        | Mark Norris    | Taken    |
	| Special Leave Paid | Training          | future date | future date | 1.50     | Submitted on today | 1.5 days     | Mark Norris    | Approved |
	| Annual Leave Days  | Annual Leave Days | future date | future date | 0.30     | Submitted on today | 0.3 day      | Mark Norris    | Approved |  
...
@connect-regression1
Scenario Outline: 05 Check filters in my absences screen
	Given I login as an employee
	Then I should see my annual leave tile in dashboard	
	When I click on create or view leave
	Then I will be redirected to the my absences page
	...
	Then I should see all my absences
	When I select type as "<type>"
	Then I should see all my "<type>" absences
	When I click on clear filters
	Then I should see all my absences
	When I select start date as "21.10.2021" and end date as "02.11.2021"
	Then I should see my absences filter by start date and end date
	When I click on status pending
	And I select type as "Sickness"
    Then I should be able to see all my pending sickness

Examples:
	| type                         | reason | startDate | endDate     |
	| Industrial Action (Half Day) | Asthma | past date | future date |  


@connect-regression1
Scenario: 06 Create Industrial Action (half day) leave request with future date
	Given I login as an employee
	Then I should see my annual leave tile in dashboard	
	When I click on create or view leave
	Then I will be redirected to the my absences page
...
Examples:
	| type                         | reason            | startDate   | endDate     | duration | durationDays | dateSubmitted      | statusPending |
	| Industrial Action (Half Day) | Industrial Action | future date | future date | 1.00     | 1 day        | Submitted on today | Pending       |

@connect-regression1
Scenario: 07 Create sick leave scenario with previous to exising one
	Given I login as an employee
	Then I should see my annual leave tile in dashboard	
	When I click on create or view leave
	Then I will be redirected to the my absences page
	...
	Then I see create absence window
	And I select type as "Sickness"
	And I select reason as "Back Problems"	
	And I select start date as "03.06.21"
	And I select end date as "03.06.21"
	And I click submit button on create absence
	Then I should see the error message

@connect-regression1
Scenario: 08 Perform my annual leave scenarios with manager credentials
	Given I login as manager
	Then I should see my annual leave tile in dashboard
	When I click on create or view leave
	Then I will be redirected to the my absences page
	When I click on status as "Pending"
	Then I verify the status selected as "Pending"
	Then I verify the status selected as "Pending"
